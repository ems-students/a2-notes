...
\begin{figure}
    ...
    \caption[graphs of $\sinh$ and $\cosh$]{The basic hyperbolic functions,
    $\sinh$ (red) and $\cosh$ (blue).}
...
\noindent The inverse functions of hyperbolic sine, hyperbolic cosine and
hyperbolic tangent are area hyperbolic sine, area hyperbolic cosine and area
hyperbolic tangent;
