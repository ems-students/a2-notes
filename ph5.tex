...
\usepackage{amsmath, amssymb, marginnote}
...
% capacitor circuit diagram symbol pls
...
\[B=\frac{\mu_0In}{l}\] % this is written in fomula bookelets as just n, not n 
                        % over l, as that is number of turns per metre
...
\marginnote{$\bar{V}$ can be written as $V_\textrm{rms}$}
